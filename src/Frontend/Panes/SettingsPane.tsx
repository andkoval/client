        ...
        <Section>
          ...
          <Row>
            ...
            <MultiSelectSetting
              ...
              values={['1', '2', '3', '5', '10', '11', '15', '20', '21', '25']}
              labels={[
                '1 gwei (default)',
                '2 gwei (faster)',
                '3 gwei (how about this?)',
                '5 gwei (turbo)',
                '10 gwei (mega turbo)',
                '11 gwei (mega turbo plus)',
                '15 gwei (a middle ground)',
                '20 gwei (need4speed)',
                '21 gwei (need4speed underground 2)',
                '25 gwei (faster then light)',
              ]}
            />
          </Row>
          <Row>
